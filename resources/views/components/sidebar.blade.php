<div class="container-fluid">
    <div id="sidebar">
        <button id="toggle-sidebar" class="toggle-btn">&#x00ab;</button> <!-- Tombol untuk memperkecil -->
        
        <div class="sidebar-header">
            <h4>Menu Utama</h4>
        </div>
        <ul class="side-bar">
            <li><a href="{{ route('laporan.suratMasuk.index') }}"><span class="glyphicon glyphicon-list"></span>  Dashboard</a></li>
        </ul>
        ...
        <ul class="side-bar">
            ...
            <li><a href="{{ route('data-petugas') }}"><span class="fas fa-users"></span> Petugas TU</a></li>
        </ul>
